...
[![GitHub Streak](https://streak-stats.demolab.com?user=codingjamee%40gmail.com&theme=highcontrast&date_format=%5BY.%5Dn.j&mode=weekly)](https://git.io/streak-stats)
...
- 타 팀원의 스켈레톤 코드에 기능 추가 :
    Onboarding : 상태관리 기능 추가, 기존의 데이터 비동기 렌더링, 마지막 onboarding시 비어있는 곳으로 navigate 기능 추가,  
...
# 2. 설치 및 사용법: $ npm install   $ npm start
